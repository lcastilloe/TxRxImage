#ifndef __rfQNvnpXFt85LXifJG1th_h__
#define __rfQNvnpXFt85LXifJG1th_h__
...
#ifndef typedef_InstanceStruct_rfQNvnpXFt85LXifJG1th
#define typedef_InstanceStruct_rfQNvnpXFt85LXifJG1th
...
typedef struct {
  ...
  creal_T (*u0_data)[317640];
  int32_T (*u0_sizes)[2];
  creal_T (*y0_data)[317640];
  int32_T (*y0_sizes)[2];
  int32_T (*v)[2];
} InstanceStruct_rfQNvnpXFt85LXifJG1th;

#endif                                 /* typedef_InstanceStruct_rfQNvnpXFt85LXifJG1th */
...
extern void method_dispatcher_rfQNvnpXFt85LXifJG1th(SimStruct *S, int_T method,
  void* data);

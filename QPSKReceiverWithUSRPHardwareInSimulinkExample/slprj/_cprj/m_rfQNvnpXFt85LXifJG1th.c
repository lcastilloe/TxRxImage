...
#include "m_rfQNvnpXFt85LXifJG1th.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_rfQNvnpXFt85LXifJG1th
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_rfQNvnpXFt85LXifJG1th
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_rfQNvnpXFt85LXifJG1th
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_rfQNvnpXFt85LXifJG1th
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_rfQNvnpXFt85LXifJG1th
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_rfQNvnpXFt85LXifJG1th
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_rfQNvnpXFt85LXifJG1th
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_rfQNvnpXFt85LXifJG1th
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, coder_array_creal_T_2D *u0,
  coder_array_creal_T_2D *b_y0);
static void mw__internal__system___fcn(InstanceStruct_rfQNvnpXFt85LXifJG1th
...
static const mxArray *emlrt_marshallOut(InstanceStruct_rfQNvnpXFt85LXifJG1th
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_rfQNvnpXFt85LXifJG1th
...
static void cgxe_mdl_set_sim_state(InstanceStruct_rfQNvnpXFt85LXifJG1th
...
static void init_simulink_io_address(InstanceStruct_rfQNvnpXFt85LXifJG1th
  *moduleInstance);
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static uint32_T uv[8] = { 317640U, 1U, 1U, 1U, 1U, 1U, 1U, 1U };
  ...
  coder_array_creal_T_2D *b_y0)
{
  ...
  emlrtDimSizeGeqCheckR2012b(317640, c_y0.size[0], &emlrtECI, (void *)sp);
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0_data = (creal_T (*)[317640])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->u0_sizes = (int32_T (*)[2])cgxertGetCurrentInputPortDimensions
    (moduleInstance->S, 0);
  moduleInstance->y0_data = (creal_T (*)[317640])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
...
/* CGXE Glue Code */
static void mdlOutputs_rfQNvnpXFt85LXifJG1th(SimStruct *S, int_T tid)
{
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_rfQNvnpXFt85LXifJG1th(SimStruct *S)
{
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_rfQNvnpXFt85LXifJG1th(SimStruct *S, int_T tid)
{
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_rfQNvnpXFt85LXifJG1th(SimStruct *S)
{
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_rfQNvnpXFt85LXifJG1th(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)cgxertGetRuntimeInstance(S);
...
static void setSimState_rfQNvnpXFt85LXifJG1th(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_rfQNvnpXFt85LXifJG1th(SimStruct *S)
{
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_rfQNvnpXFt85LXifJG1th(SimStruct *S)
{
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_rfQNvnpXFt85LXifJG1th(SimStruct *S)
{
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_rfQNvnpXFt85LXifJG1th(SimStruct *S)
{
  InstanceStruct_rfQNvnpXFt85LXifJG1th *moduleInstance =
    (InstanceStruct_rfQNvnpXFt85LXifJG1th *)calloc(1, sizeof
    (InstanceStruct_rfQNvnpXFt85LXifJG1th));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_rfQNvnpXFt85LXifJG1th);
  ssSetmdlInitializeConditions(S, mdlInitialize_rfQNvnpXFt85LXifJG1th);
  ssSetmdlUpdate(S, mdlUpdate_rfQNvnpXFt85LXifJG1th);
  ssSetmdlDerivatives(S, mdlDerivatives_rfQNvnpXFt85LXifJG1th);
  ssSetmdlTerminate(S, mdlTerminate_rfQNvnpXFt85LXifJG1th);
  ssSetmdlEnable(S, mdlEnable_rfQNvnpXFt85LXifJG1th);
  ssSetmdlDisable(S, mdlDisable_rfQNvnpXFt85LXifJG1th);
...
static void mdlProcessParameters_rfQNvnpXFt85LXifJG1th(SimStruct *S)
{
}

void method_dispatcher_rfQNvnpXFt85LXifJG1th(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_rfQNvnpXFt85LXifJG1th(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_rfQNvnpXFt85LXifJG1th(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_rfQNvnpXFt85LXifJG1th(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_rfQNvnpXFt85LXifJG1th(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: rfQNvnpXFt85LXifJG1th.\n"
...
mxArray *cgxe_rfQNvnpXFt85LXifJG1th_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_rfQNvnpXFt85LXifJG1th_fallback_info(void)
{
